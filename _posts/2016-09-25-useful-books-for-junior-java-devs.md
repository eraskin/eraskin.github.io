...
![image-left]({{ site.url }}{{ site.baseurl }}/images/java_oracle_book-242x300.jpg){: .align-left} Более традиционная книга, написанная, скорее, в академичном стиле, если сравнивать с Head First Java. 
